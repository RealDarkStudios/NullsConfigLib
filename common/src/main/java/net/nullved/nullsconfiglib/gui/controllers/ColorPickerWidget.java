...
public class ColorPickerWidget extends ControllerPopupWidget<ColorController> {
    private static final ResourceLocation COLOR_PICKER_LOCATION = NCLPlatform.rl("controller/color_picker");
    private static final ResourceLocation TRANSPARENT_TEXTURE_LOCATION = NCLPlatform.rl("controller/transparent");
    ...
    public ColorPickerWidget(ColorController controller, NCLScreen screen, Dimension<Integer> widgetDimension,
                             ColorController.ColorControllerElement entryWidget) {
        super(controller, screen, widgetDimension, entryWidget);
    ...
    public Component popupTitle() {
        return Component.translatable("ncl.control.color.color_picker_title");
    }

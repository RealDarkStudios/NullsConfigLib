...
public class LabelController implements IController<Component> {
    private final IOption<Component> option;

    public LabelController(IOption<Component> option) {
        this.option = option;
    }

    @Override
    public IOption<Component> option() {
        return option;
    }
    ...
    public class LabelControllerElement extends AbstractWidget {
        ...
        public LabelControllerElement(NCLScreen screen, Dimension<Integer> widgetDimension) {
        ...
        public void render(GuiGraphics graphics, int mouseX, int mouseY, float delta) {
            ...
            if (isMouseOver(mouseX, mouseY)) {
                //NCLScreen.renderMultilineTooltip(graphics, textRenderer, wrappedTooltip, getDimension().centerX(), getDimension().y() - 5, getDimension().yLimit() + 5, screen.width, screen.height);
                    ...
                    if (itemStackContent != null) {
                        ...
                        if (entityContent != null) {
                            ...
                            if (text != null) {
                                ...
                                NCLScreen.renderMultilineTooltip(graphics, textRenderer, multilineText, getDimension().centerX(), getDimension().y(), getDimension().yLimit(), screen.width, screen.height);
                            }
                        }
                    }
                }

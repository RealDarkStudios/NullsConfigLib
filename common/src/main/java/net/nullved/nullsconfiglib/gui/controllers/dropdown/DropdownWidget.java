...
public class DropdownWidget<T> extends ControllerPopupWidget<AbstractDropdownController<T>> {
    ...
    public DropdownWidget(AbstractDropdownController<T> control, NCLScreen screen, Dimension<Integer> dim, AbstractDropdownControllerElement<T, ?> dropdownElement) {
    ...
    public Component popupTitle() {
        return Component.translatable("ncl.control.dropdown.dropdown_widget_title");
    }
}

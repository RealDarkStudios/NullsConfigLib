...
public abstract class AbstractDropdownControllerElement<T, U> extends StringControllerElement {
    ...
    public AbstractDropdownControllerElement(AbstractDropdownController<T> control, NCLScreen screen, Dimension<Integer> dim) {
    ...
    protected void renderDropdownEntry(GuiGraphics graphics, Dimension<Integer> entryDimension, U value) {
        ...
        Component text;
        if (entry.isBlank()) {
            text = Component.translatable("ncl.control.text.blank").withStyle(ChatFormatting.GRAY);
        } else {
